...
> i.在敌人坦克类，使用Vector保存多个Shot        
> ii.当每创建一个敌人坦克对象，给该敌人坦克对象初始化一个Shot对象，同时启动Shot       
> iii.在绘制敌人坦克时，需要遍历敌人坦克对象Vector,绘会制所有的子弹,当子弹isLive == false时，就从Vector移除           
> 2.当我方坦克击中敌人坦克时，敌人的坦克就消失,如果能做出爆炸效果更好.          
> 3.让敌人的坦克也可以自由随机的上下左右移动           
> i.因为要求敌人的坦克，可以自由移动，因此需要将敌人坦克当做线程使用           
> ii.因为要求敌人的坦克，可以自由移动，因此需要将敌人坦克当做线程使用            
> iii.在run方法写上我们相应的业务代码                           
> iv.在创建敌人坦克对象时，启动线程                  
...
> 4.练习:让敌人坦克可以最多发射3颗(在面板E)，我们的坦克可以发射3颗.并且能够出现正常的爆炸效果即可                
```java
