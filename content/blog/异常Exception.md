...
![try-catch-finally处理机制示意图](/assets/异常/try-catch-finally处理机制示意图.png)
...
> 5.可以进行try-finally配合使用,这种用法相当于没有捕获异常，因此程序会 直接崩掉/退出。应用场景就是执行一段代码，不管是否发生异常，都必须执行某个业务逻辑。   
...
![throw和throws的区别](/assets/异常/throw和throws的区别.png)
