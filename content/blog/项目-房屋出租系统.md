...
![主菜单](/assets/项目-房屋出租系统/主菜单.png)

## 2. 项目界面- 新增房源

![新增房源](/assets/项目-房屋出租系统/新增房源.png)

## 3. 项目界面- 查找房源

![查找房源](/assets/项目-房屋出租系统/查找房源.png)

## 4. 项目界面- 删除房源

![删除房源](/assets/项目-房屋出租系统/删除房源.png)

## 5. 项目界面- 修改房源

![修改房源](/assets/项目-房屋出租系统/修改房源.png)

## 6. 项目界面- 房屋列表

![房屋列表](/assets/项目-房屋出租系统/房屋列表.png)

## 7. 项目界面- 退出系统

![退出系统](/assets/项目-房屋出租系统/退出系统.png)
...
## 2. 项目功能实现-显示主菜单和完成退出软件功能

> 1. 实现功能的三部曲[明确完成功能->思路分析->代码实现]  
> 2. 功能说明: 用户打开软件， 可以看到主菜单，可以退出软件.  
> 3. 思路分析: 在HouseView.java 中，编写一个方法mainMenu,显示菜单.  
```java
